...
<%--                    <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/tuisai.do">退赛信息</a></li>--%>
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <h1>修改竞赛</h1>
            <form method="post" name="updateCompetition" action="${pageContext.request.contextPath}/updateCompetition.do">

                    ${requestScope.idLength}
                    <br>
                    <label>编号：
                        <input type="text" name="id" readonly="readonly" value=<%=request.getParameter("id")%>>
                    </label>

                    ${requestScope.competitionNameNull}
                    <br>
                    <label>名称：
                        <input type="text" name="competitionName" value=<%=request.getParameter("competition")%>>
                    </label>
                    ...
                    <label>教师ID：
                        <input type="text" name="teacherId" value=<%=request.getParameter("teacherid")%>>
                    </label>
                    <label>教师：
                        <input type="text" name="teacherName" value=<%=request.getParameter("teacher")%>>
                    </label>
