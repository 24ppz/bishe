...
layui.define("jquery", function (i) {
    "use strict";
    var a = layui.$, t = (layui.hint(), layui.device()), l = "element", e = "layui-this", n = "layui-show",
        s = function () {
            this.config = {}
        };
    s.prototype.set = function (i) {
        ...
        var l = ".layui-tab-title", e = a(".layui-tab[lay-filter=" + i + "]"), n = e.children(l),
            s = n.children(".layui-tab-bar"), o = e.children(".layui-tab-content"),
        ...
        h = "layui-nav-more", f = "layui-anim layui-anim-upbit", y = {
            tabClick: function (i, t, s) {
                var o = s || a(this), t = t || o.parent().children("li").index(o), c = o.parents(".layui-tab").eq(0),
                    r = c.children(".layui-tab-content").children(".layui-tab-item"), u = o.find("a"),
                    d = c.attr("lay-filter");
...
layui.define("layer", function (e) {
    ...
    var i = layui.$, t = layui.layer, n = layui.hint(), a = layui.device(), o = {
        ...
        }, r = "upload", u = "layui-upload-file", c = "layui-upload-form", s = "layui-upload-iframe",
        f = "layui-upload-choose", p = function (e) {
            var t = this;
...
layui.define("layer", function (e) {
    ...
    var i = layui.$, t = layui.layer, a = layui.hint(), n = layui.device(), l = "form", s = ".layui-form",
        r = "layui-this", u = "layui-hide", c = "layui-disabled", o = function () {
            this.config = {
                verify: {
                    required: [/[\S]+/, "必填项不能为空"],
        ...
        var n = this, o = i(s + function () {
            ...
            select: function () {
                var e, t = "请选择", a = "layui-form-select", n = "layui-select-title", s = "layui-select-none", d = "",
                    f = o.find("select"), y = function (t, l) {
                ...
                f.each(function (e, l) {
                    var s = i(this), u = s.next("." + a), o = this.disabled, d = l.value,
                ...
                t.each(function (t, n) {
                    ...
                    var d = l.next("." + o[0]),
                        f = i(['<div class="layui-unselect ' + o[0] + (n.checked ? " " + o[1] : "") + (u ? " layui-checkbox-disbaled " + c : "") + '" lay-skin="' + (s || "") + '">', {_switch: "<em>" + ((n.checked ? r[0] : r[1]) || "") + "</em><i></i>"}[s] || (n.title.replace(/\s/g, "") ? "<span>" + n.title + "</span>" : "") + '<i class="layui-icon">' + (s ? "&#xe605;" : "&#xe618;") + "</i>", "</div>"].join(""));
                    d[0] && d.remove(), l.after(f), a.call(this, f, o)
                })
            }, radio: function () {
                var e = "layui-form-radio", t = ["&#xe643;", "&#xe63f;"], a = o.find("input[type=radio]"),
                    n = function (a) {
                        var n = i(this), r = "layui-anim-scaleSpring";
                        a.on("click", function () {
                            var u = n[0].name, c = n.parents(s), o = n.attr("lay-filter"),
    ...
    var d = function () {
        var e = i(this), a = f.config.verify, r = null, u = "layui-form-danger", c = {}, o = e.parents(s),
            d = o.find("*[lay-verify]"), y = e.parents("form")[0], v = o.find("input,select,textarea"),
            h = e.attr("lay-filter");
...
layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form, o = layui.hint(),
        ...
        p = ".layui-table-body", m = ".layui-table-main", v = ".layui-table-fixed", g = ".layui-table-fixed-l",
        x = ".layui-table-fixed-r", b = ".layui-table-tool", k = ".layui-table-sort", w = "layui-table-edit",
        C = "layui-table-hover", z = function (e) {
    ...
    A.prototype.config = {limit: 30, loading: !0}, A.prototype.render = function (e) {
        ...
        return c.key = s.id || s.index, d.cache[c.key] = u, r ? p() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.html('<div class="layui-none">无数据</div>')) : (p(), void (s.page && (c.page = n, c.count = o, a.render({
        ...
        u.sortKey = {
            field: r,
            sort: i
        }, "asc" === i ? c = layui.sort(y, r) : "desc" === i ? c = layui.sort(y, r, !0) : (c = layui.sort(y, d.config.indexName), delete u.sortKey), u.renderData({data: c}, u.page, u.count, !0), l.close(u.tipsIndex), n && layui.event.call(e, s, "sort(" + h + ")", {
            field: r,
            type: i
        })
        ...
        t.fullHeightGap && (a = T.height() - t.fullHeightGap, a < 135 && (a = 135), t.elem.css("height", a)), e = parseFloat(a) - parseFloat(t.layHeader.height()) - 1, i.page && (e -= parseFloat(t.layTool.outerHeight() + 1)), t.layMain.css("height", e)
        ...
        var o = e.layMain.height(), r = o - l;
        e.layFixed.find(p).css("height", i.height() > r ? r : "auto"), e.layFixRight[i.width() > e.layMain.width() ? "removeClass" : "addClass"](f), e.layFixRight.css("right", a - 1)
    }, A.prototype.events = function () {
        var e, a = this, n = a.config, o = t("body"), c = {}, u = a.layHeader.find("th"), f = ".layui-table-cell",
        ...
        return l.each(function () {
            ...
            e && a.hide(), a.find("thead>tr").each(function (e) {
                s.cols[e] = [], t(this).children().each(function (i) {
                    ...
                    var d = t.extend({
                        title: a.text(),
                        colspan: a.attr("colspan") || null,
                        rowspan: a.attr("rowspan") || null
                    }, l);
                    d.field && c.push(d), s.cols[e].push(d)
                })
...
layui.define("jquery", function (e) {
    ...
    var i = layui.$, n = (layui.hint(), layui.device(), {
        ...
        }), t = "carousel", a = "layui-this", o = ">*[carousel-item]>*", l = "layui-carousel-left",
