...
<%--          <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/tuisai.do">退赛信息</a></li>--%>
          ...
          <li class="layui-nav-item layui-this"><a href="${pageContext.request.contextPath}/jsp/admin/fabu.jsp">发布公告</a></li>
  ...
  <div class="layui-body">
    ...
    <div style="padding: 15px;">
      ...
      ${requestScope.info}
      <form action="${pageContext.request.contextPath}/fabu.do" method="post" enctype="multipart/form-data">
        <p>上传公告文件：<input type="file" name="file"></p>
        <p>
