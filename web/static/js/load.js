    ...
    e.prototype = {
        init: function () {
            ...
            b.template = {
                ...
                table: {head: "<table border='1'>", tail: "</table>"},
                foot: "</body></html>"
            ...
            if (k.format = function (a, b) {
                ...
                table: d,
                sheetName: g
            }, l = k.template.head, a.isArray(d)) for (h in d) l += k.template.sheet.head + g + h + k.template.sheet.tail;
            ...
            if (delete k.ctx.table, !c.documentMode) {
                var m = new Blob([k.format(l, k.ctx)], {type: "application/vnd.ms-excel"});
