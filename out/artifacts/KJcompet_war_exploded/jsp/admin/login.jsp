...
<body>
<form name="studentLogin" action="${pageContext.request.contextPath}/adminLogin.do" method="post">
    <center>
        <div>
            <h2>
                大学生线上科技竞赛报名系统
            ...
            <p>
                账号:<label>
                <input type="text" name="id" placeholder="GM号"/>
            </label>
            </p>
            <p>
                密码:<label>
            ...
            <p>
                <input id="adminLogin" type="submit" value="管理员登录"/>
            </p>
            <p>
