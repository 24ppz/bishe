            ...
            <div>
                ...
                <table class="table" border="5px">
                    ...
                    <tr>
                        ...
                        <td>
                            ${sessionScope.teacherSession.teacherName}
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ${sessionScope.teacherSession.department}
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <a class="a" href="${pageContext.request.contextPath}/jsp/teacher/changePwd.jsp">
